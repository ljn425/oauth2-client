package springsecurity.oauth2client.filter;
...
public class CustomOAuth2AuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public static final String DEFAULT_FILTER_PROCESSES_URL = "/oauth2Login/**";
    ...
    public CustomOAuth2AuthenticationFilter(DefaultOAuth2AuthorizedClientManager authorizedClientManager, OAuth2AuthorizedClientRepository authorizedClientRepository) {
        ...
        this.successHandler = (authorizedClient, principal, attributes) -> this.authorizedClientRepository
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException, IOException, ServletException {
        ...
        if(oAuth2AuthorizedClient != null) {
            ...
            successHandler.onAuthorizationSuccess(oAuth2AuthorizedClient, oAuth2AuthenticationToken, createAttributes(request, response));
